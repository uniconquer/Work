#include "pch.h"
#include "M1EngineMain.h"
#include "Common\DirectXHelper.h"

using namespace M1Engine;
...
// 렌더러를 만들고 초기화합니다.
void M1EngineMain::CreateRenderers(const std::shared_ptr<DX::DeviceResources>& deviceResources)
{
...
void M1EngineMain::OnWindowSizeChanged()
{
...
void M1EngineMain::OnSuspending()
{
...
void M1EngineMain::OnResuming()
{
	// TODO: 이것을 앱의 다시 시작 논리로 바꾸세요.
}

// 릴리스가 필요한 장치 리소스를 렌더러에 알립니다.
void M1EngineMain::OnDeviceRemoved()
{
